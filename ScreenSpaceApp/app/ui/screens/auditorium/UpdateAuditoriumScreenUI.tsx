import {
  ...
  const UpdateAuditoriumScreenUI = ({}) => {
    ...
    return (
     ...
     <View style={styles.switchcontainer}>
        <View style={{ backgroundColor: '#21242D', paddingHorizontal: 40, paddingVertical: 10, borderRadius: 8,flexDirection: 'row' }}>
        <Text>Available</Text>
      <Switch
  ...
  export default UpdateAuditoriumScreenUI;

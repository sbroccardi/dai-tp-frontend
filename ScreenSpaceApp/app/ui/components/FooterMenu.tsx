  ...
  selected: any;
    ...
    return (
        ...
        <HStack bg="#21242D" alignItems="center" safeAreaBottom shadow={6} borderRadius="12">
          <Pressable opacity={selected === 0 ? 1 : 0.5} py="3" flex={1} onPress={() => navigation.navigate('Login')}>
            <Center>
          ...
          <Pressable opacity={selected === 1 ? 1 : 0.5} py="2" flex={1} onPress={() => navigation.navigate('Login')}>
            <Center>
          ...
          <Pressable opacity={selected === 2 ? 1 : 0.6} py="2" flex={1} onPress={() => navigation.navigate('ProfilePrivate')}>
            <Center>
